      ...
      <main className="flex-grow pt-24">
        <div className="container mx-auto px-4 py-12 max-w-4xl">
          ...
          <div className="prose prose-blue max-w-none">
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4">Wat zijn cookies?</h2>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4">Welke cookies gebruiken wij?</h2>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4">Cookies van derden</h2>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4">Uw keuzes</h2>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4">Wijzigingen in deze verklaring</h2>
